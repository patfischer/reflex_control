...
class FollowWaypointsGoal(genpy.Message):
  _md5sum = "f9dd1ecaca467369f5088c9834a86ece"
...
float64 w
"""
  __slots__ = ['waypoints','velocities','segment_durations']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       waypoints,velocities,segment_durations
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.segment_durations)
      buff.write(_struct_I.pack(length))
      for val1 in self.segment_durations:
        _x = val1
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.segment_durations.append(val1)
      return self
