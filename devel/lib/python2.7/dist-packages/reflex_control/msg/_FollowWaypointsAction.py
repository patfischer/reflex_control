...
"""autogenerated by genpy from reflex_control/FollowWaypointsAction.msg. Do not edit."""
import sys
...
class FollowWaypointsAction(genpy.Message):
  _md5sum = "4366dd9f281e44a1bbb4fdcdce4ece11"
  _type = "reflex_control/FollowWaypointsAction"
...
"""
  ...
  _slot_types = ['reflex_control/FollowWaypointsActionGoal','reflex_control/FollowWaypointsActionResult','reflex_control/FollowWaypointsActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = reflex_control.msg.FollowWaypointsActionGoal()
      if self.action_result is None:
        self.action_result = reflex_control.msg.FollowWaypointsActionResult()
      if self.action_feedback is None:
        self.action_feedback = reflex_control.msg.FollowWaypointsActionFeedback()
    else:
      self.action_goal = reflex_control.msg.FollowWaypointsActionGoal()
      self.action_result = reflex_control.msg.FollowWaypointsActionResult()
      self.action_feedback = reflex_control.msg.FollowWaypointsActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.action_goal.goal.segment_durations)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.segment_durations:
        _x = val1
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.segment_durations = []
      for i in range(0, length):
        val1 = genpy.Duration()
        _x = val1
        start = end
        ...
        self.action_goal.goal.segment_durations.append(val1)
      _x = self
      start = end
      end += 12
