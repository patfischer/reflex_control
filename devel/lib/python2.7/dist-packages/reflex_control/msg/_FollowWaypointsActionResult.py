...
"""autogenerated by genpy from reflex_control/FollowWaypointsActionResult.msg. Do not edit."""
import sys
...
class FollowWaypointsActionResult(genpy.Message):
  _md5sum = "fcd3f89768faeea6dcde4cefb915c079"
  _type = "reflex_control/FollowWaypointsActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','reflex_control/FollowWaypointsResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FollowWaypointsActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = reflex_control.msg.FollowWaypointsResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = reflex_control.msg.FollowWaypointsResult()
