...
class FollowWaypointsActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = FollowWaypointsFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new FollowWaypointsActionFeedback(null);
    ...
    data.feedback = FollowWaypointsFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new FollowWaypointsActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = FollowWaypointsFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new FollowWaypointsFeedback()
    }
...
module.exports = FollowWaypointsActionFeedback;
