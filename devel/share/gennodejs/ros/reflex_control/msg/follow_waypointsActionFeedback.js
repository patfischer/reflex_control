...
class follow_waypointsActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new follow_waypointsFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = follow_waypointsFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new follow_waypointsActionFeedback(null);
    ...
    data.feedback = follow_waypointsFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new follow_waypointsActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = follow_waypointsFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new follow_waypointsFeedback()
    }
...
module.exports = follow_waypointsActionFeedback;
