...
if("FALSE" STREQUAL "TRUE")
  set(reflex_control_SOURCE_PREFIX /home/fischer/ws_ma/src/franka_example_controllers)
...
if(NOT "include;/opt/ros/kinetic/include/libfranka " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'reflex_control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/fischer/ws_ma/install/${idir}'.  ${_report}")
    endif()
