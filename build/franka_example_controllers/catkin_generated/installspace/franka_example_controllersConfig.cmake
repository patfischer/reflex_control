...
if("FALSE" STREQUAL "TRUE")
  set(franka_example_controllers_SOURCE_PREFIX /home/fischer/ws_ma/src/franka_example_controllers)
  set(franka_example_controllers_DEVEL_PREFIX /home/fischer/ws_ma/devel)
  ...
  set(franka_example_controllers_INSTALL_PREFIX /home/fischer/ws_ma/install)
...
if(NOT "include;/opt/ros/kinetic/include/libfranka " STREQUAL " ")
  set(franka_example_controllers_INCLUDE_DIRS "")
  set(_include_dirs "include;/opt/ros/kinetic/include/libfranka")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'franka_example_controllers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/fischer/ws_ma/install/${idir}'.  ${_report}")
    endif()
    _list_append_unique(franka_example_controllers_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "franka_example_controllers;/opt/ros/kinetic/lib/libfranka.so.0.5.0")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/fischer/ws_ma/install/lib;/home/fischer/ws_ma/devel/lib;/home/fischer/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
