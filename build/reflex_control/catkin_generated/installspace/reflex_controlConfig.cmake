...
if(NOT "include;/opt/ros/kinetic/include/libfranka " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'reflex_control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/fischer/reflex_control/install/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/fischer/reflex_control/install/lib;/home/fischer/reflex_control/devel/lib;/opt/ros/kinetic/lib)
